    ...
    <>
      ...
      {isOpen && (
        <div className="text-black font-kode dark:text-white fixed inset-0 bg-black/30 z-50 flex items-center justify-center">
          <div className="rounded-2xl relative w-3xs sm:w-xs md:w-md h-fit bg-white dark:bg-black border-2 p-4">
            <button className="cursor-pointer absolute top-0 right-0 p-2" onClick={handleClose}>
              <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="lucide lucide-x-icon lucide-x"><path d="M18 6 6 18"/><path d="m6 6 12 12"/></svg>
            </button>
              <div className="w-full flex flex-col items-center justify-center mt-4 gap-4">
                <p className="text-lg font-bold text-center">✨ Comparte mi tarjeta digital</p>
